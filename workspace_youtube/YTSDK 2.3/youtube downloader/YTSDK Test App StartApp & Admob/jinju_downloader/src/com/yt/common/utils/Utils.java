...
public class Utils {
	...
	public static void shareApp(Context contex) {
		...
		sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT,
				contex.getString(R.string.yt_app_name));
		sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT,
				contex.getString(R.string.yt_shareText) + " --> Download the app "
						+ marketWebLink);
	...
	public static String getDBAppName(Context context) {
		String appName = null;
		try {
			appName = context.getResources().getString(R.string.yt_app_name);
