...
public class YouTubeAPIDemoActivity extends Activity implements OnItemClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.youtuble_demo_home);
    ...
    DemoArrayAdapter adapter = new DemoArrayAdapter(this, R.layout.youtuble_list_item, activities);
  ...
  public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    ...
    //jG.Log.d("getPackageName() = " + getPackageName() + " clickedDemo.className = " + clickedDemo.className);
