...
public class FragmentTabs extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar.addTab(bar.newTab()
                .setText("Throttle")
                .setTabListener(new TabListener<LoaderThrottle_apidemo.ThrottledLoaderListFragment>(
                        this, "throttle", LoaderThrottle_apidemo.ThrottledLoaderListFragment.class)));
